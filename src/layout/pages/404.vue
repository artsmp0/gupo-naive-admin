  ...
  <div class="wscn-http404-container">
    <div class="wscn-http404 md:flex">
      <div class="pic-404 dark:opacity-70 md:w-550!">
        ...
        <img alt="404" class="pic-404__child right" src="@/assets/imgs/404_cloud.png" />
      </div>
      <div class="bullshit">
        <div class="bullshit__oops">哎呀!</div>
        <div class="bullshit__headline">找不到您所要查找的页面...</div>
        <div class="bullshit__info">请检查您输入的网址是否正确，或点击下面的按钮返回主页。</div>
        <NButton type="info" round @click="backHome">回到主页</NButton>
      </div>
    </div>
  </div>
</template>
